<div class="row-fluid">
	<div class="span4 thumbnail">
		<h3>
			...
			<?php echo JText::_('COM_FOOD_STATISTICS_TOTAL_BOOKS'); ?>
		</h3>
		...
		<p><?php echo JText::_('COM_FOOD_STATISTICS_TOTAL_BOOKS_DESC'); ?></p>
	</div>

	<div class="span4 thumbnail">
		<h3>
			<span class="label label-info pull-right"><?php echo $this->stats['total_reviews']; ?></span>
			<?php echo JText::_('COM_FOOD_STATISTICS_TOTAL_REVIEWS'); ?>
		</h3>
		<div class="progress progress-success">
...
<div class="row-fluid">
	<div class="span4 thumbnail">
		<h3>
			...
			<?php echo JText::_('COM_FOOD_STATISTICS_AVG_WISHLIST'); ?>
		</h3>
